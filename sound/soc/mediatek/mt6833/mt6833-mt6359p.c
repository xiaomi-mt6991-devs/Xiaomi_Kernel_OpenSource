...
/*
 *  mt6833-mt6359.c  --  mt6833 mt6359p ALSA SoC machine driver
 *
...
static int mt6833_mt6359_mtkaif_calibration(struct snd_soc_pcm_runtime *rtd)
{
	...
	miso0_need_calib = mt6833_afe_gpio_is_prepared(MT6833_AFE_GPIO_DAT_MISO0_ON);
	miso1_need_calib = mt6833_afe_gpio_is_prepared(MT6833_AFE_GPIO_DAT_MISO1_ON);
	miso2_need_calib = mt6833_afe_gpio_is_prepared(MT6833_AFE_GPIO_DAT_MISO2_ON);
