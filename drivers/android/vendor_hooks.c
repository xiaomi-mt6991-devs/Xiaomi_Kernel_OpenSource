...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_binder_transaction_priority);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_workingset_active);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_mglru_shrink_spec_lru);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_set_balance_anon_file_reclaim);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_show_max_freq);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_rvh_shrink_spec_lru);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_try_to_freeze_abort);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_page_cache_ra_mark);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_filemap_fault_post_folio_locked);
...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_map_order0_folio);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_do_fault_around);
