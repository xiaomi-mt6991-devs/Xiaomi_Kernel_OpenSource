...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0xB6, 0x30, 0x6b, 0x00, 0x02, 0x03);
	lcm_dcs_write_seq_static(ctx, 0xB7, 0x51, 0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xB8, 0x57, 0x3d, 0x19, 0xbe, 0x1e, 0x0a, 0x0a);
	lcm_dcs_write_seq_static(ctx, 0xB9, 0x6f, 0x3d, 0x28, 0xbe, 0x3c, 0x14, 0x0a);
	lcm_dcs_write_seq_static(ctx, 0xBA, 0xb5, 0x33, 0x41, 0xbe, 0x64, 0x23, 0x0a);
	lcm_dcs_write_seq_static(ctx, 0xBB, 0x44, 0x26, 0xc3, 0x1f, 0x19, 0x06, 0x03, 0xc0, 0x00,
				0x00, 0x10);
	lcm_dcs_write_seq_static(ctx, 0xBC, 0x32, 0x4c, 0xc3, 0x52, 0x32, 0x1f, 0x03, 0xf2, 0x00,
				0x00, 0x13);
	lcm_dcs_write_seq_static(ctx, 0xBD, 0x24, 0x68, 0xc3, 0xaa, 0x3f, 0x32, 0x03, 0xff, 0x00,
				0x00, 0x25);
	lcm_dcs_write_seq_static(ctx, 0xBE, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xC0, 0x00, 0xbf, 0x01, 0x2c, 0x07, 0x09, 0xd8, 0x00, 0x05,
				0x00, 0x00, 0x08, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xC1, 0xC1, 0x30, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00, 0x00,
		0x22, 0x00, 0x05, 0x20, 0x00, 0x80, 0xfa, 0x40, 0x00, 0x80,
		0x0f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xC2, 0x05, 0xf0, 0x5f, 0x01, 0x03, 0x10, 0x04, 0x02, 0x00,
	...
	lcm_dcs_write_seq_static(ctx, 0xC3, 0x01, 0x20, 0x12, 0x01, 0x00, 0x20, 0x03, 0x04, 0x01,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	...
	lcm_dcs_write_seq_static(ctx, 0xC4, 0x00, 0x00, 0x00, 0x00, 0x4f, 0x00, 0x3e, 0x3f, 0x4f,
	...
	lcm_dcs_write_seq_static(ctx, 0xC6, 0x00, 0x0a, 0x08, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00,
		...
		0x00, 0x10, 0x00);
	//GAMMA2.2_20180522
	lcm_dcs_write_seq_static(ctx, 0xC7, 0x00, 0xF6, 0x01, 0x8D, 0x01, 0xE3, 0x01, 0xE7, 0x01,
	...
	lcm_dcs_write_seq_static(ctx, 0xCB, 0xCB, 0xa0, 0x80, 0x70, 0x00, 0x20, 0x00, 0x00, 0x2d,
		0x41, 0x00, 0x00, 0x00, 0x00, 0xff);
	lcm_dcs_write_seq_static(ctx, 0xCE, 0x5d, 0x40, 0x49, 0x53, 0x59, 0x5e, 0x63, 0x68, 0x6e,
		0x74, 0x7e, 0x8a, 0x98, 0xa8, 0xbb, 0xd0, 0xe7, 0xff, 0x04,
		0x00, 0x04, 0x04, 0x42, 0x00, 0x69, 0x5a, 0x40, 0x40, 0x00,
		0x00, 0x04, 0xfa, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xCF, 0x00, 0x00, 0x80, 0xa1, 0x6a, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xD0, 0xc7, 0x1e, 0x8a, 0x66, 0x09, 0x90, 0x00, 0xcc, 0x0f,
			0x05, 0xc7, 0x14, 0x12, 0xfe, 0x09, 0x09, 0xcc, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xD1, 0xdb, 0xdb, 0x1b, 0xb0, 0x07, 0x07, 0x3b, 0x11, 0xf1,
		0x11, 0xf1, 0x05, 0x33, 0x73, 0x07, 0x33, 0x33, 0x70, 0xd3,
		0xd0, 0x06, 0x96, 0x13, 0x93, 0x22, 0x22, 0x22, 0xb3, 0xbb,
			0x00);
	lcm_dcs_write_seq_static(ctx, 0xD2, 0x00, 0x00, 0x00, 0x02, 0x7f, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xD3, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		...
		0xf7, 0xff, 0xff, 0xf7, 0xff, 0xff, 0xf7, 0xff, 0xff, 0xf7,
		0xff, 0xff, 0xf7, 0xff);
	lcm_dcs_write_seq_static(ctx, 0xD4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00);
	//And,VCOM,reference,setting,
	lcm_dcs_write_seq_static(ctx, 0xE5, 0x03);
	lcm_dcs_write_seq_static(ctx, 0xD5, 0x00, 0x26);//26
	lcm_dcs_write_seq_static(ctx, 0xD7, 0x21, 0x10, 0x52, 0x52, 0x00, 0xbf, 0x00, 0x05, 0x00,
	...
	lcm_dcs_write_seq_static(ctx, 0xD8, 0x00, 0x12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	...
	lcm_dcs_write_seq_static(ctx, 0xDE, 0x00, 0x00, 0x00, 0x0f, 0xff, 0x00, 0x00, 0x00, 0x00,
					0x10);
	lcm_dcs_write_seq_static(ctx, 0xE8, 0x00, 0x30, 0x63, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xEA, 0x01, 0x0e, 0x01, 0x40, 0x0c, 0x00, 0x00, 0x00, 0x09,
		0x00, 0x02, 0xae, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x04, 0xc2, 0x00, 0x11, 0x00, 0xbf, 0x0b, 0xf0, 0x86);
	lcm_dcs_write_seq_static(ctx, 0xEB, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x11);
	lcm_dcs_write_seq_static(ctx, 0xEC, 0x04, 0xe0, 0x00, 0x10, 0x30, 0x0c, 0x00, 0x00, 0x02,
				0x3a);
	lcm_dcs_write_seq_static(ctx, 0xED, 0x01, 0x01, 0x02, 0x02, 0x08, 0x08, 0x09, 0x09, 0x00,
		0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x12, 0x02,
		0x8c, 0x00, 0x00, 0x00, 0x50, 0x00, 0x02, 0x8c, 0x00, 0x00,
		0xa0, 0x10, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xEE, 0x03, 0x3f, 0xf0, 0x03, 0x00, 0xf0, 0x03, 0x00, 0x00,
	...
	lcm_dcs_write_seq_static(ctx, 0xEF, 0x01, 0xf0, 0x56, 0x08, 0xd0, 0x00, 0x00, 0x00, 0x00,
		...
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x03, 0x00, 0x02);
	lcm_dcs_write_seq_static(ctx, 0xF9, 0x44, 0x3f, 0x00, 0x8d, 0xbf);
	lcm_dcs_write_seq_static(ctx, 0xB0, 0x03);
	lcm_dcs_write_seq_static(ctx, 0xB0, 0x00);//Unlock,Manufacture,Command,Access,Protect
	lcm_dcs_write_seq_static(ctx, 0x36, 0xF1);//inversion
	lcm_dcs_write_seq_static(ctx, 0xD6, 0x00);//OTP/Flash,Load,setting
	lcm_dcs_write_seq_static(ctx, 0xB0, 0x03);//Manufacture,Command,Access,Protect
	//TE ON
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "td4320,fhdp,auo,vdo", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-td4320-fhdp-auo-vdo",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("td4320 AUO VDO LCD Panel Driver");
