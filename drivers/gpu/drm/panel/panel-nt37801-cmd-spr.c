...
#if IS_ENABLED(CONFIG_RT4831A_I2C)
	_gate_ic_Power_off();
#elif IS_ENABLED(CONFIG_RT5081_PMU_DSV) || IS_ENABLED(CONFIG_REGULATOR_MT6370)
...
static struct mtk_panel_params ext_params = {
	...
	.spr_params = {
		...
		//.rg_xy_swap = 1,
		.spr_ip_params = nt37801_nvt_spr_ip_full_bgrg_cfg,
		.spr_ip_shrink_params = nt37801_nvt_spr_ip_shrink_bgrg_cfg,
		.mtk_spr_ip_params = nt37801_mtk_spr_ip_bgrg_cfg,
