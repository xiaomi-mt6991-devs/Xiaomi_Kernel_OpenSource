...
DEVICE_MODULES_PATH = $(srctree)/../kernel/kernel_device_modules-6.6
...
$(info [GPU_DEBUG] DEVICE_MODULES_PATH = $(srctree))
ccflags-y += \
...
ccflags-y += \
	...
	-I$(srctree)/drivers/gpu/mediatek/ged/ \
	-I$(srctree)/drivers/misc/mediatek/include/mt-plat/ \
	-I$(srctree)/drivers/gpu/mediatek/hal/ \
	-I$(srctree)/drivers/gpu/mediatek/gpu_bm \
	-I$(srctree)/drivers/gpu/mediatek/gpufreq/ \
	-I$(srctree)/drivers/gpu/mediatek/gpufreq/v2 \
	-I$(srctree)/drivers/gpu/mediatek/gpufreq/v2_legacy/include \
	-I$(srctree)/drivers/gpu/mediatek/gpufreq/v2_legacy/ \
