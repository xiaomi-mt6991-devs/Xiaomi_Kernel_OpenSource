...
#include "mdp_engine_mt6761.h"
#include "mdp_base_mt6761.h"
#include <cmdq-util.h>
...
int32_t cmdqMdpClockOn(uint64_t engineFlag)
{
	...
	/* Disable IMG_DL_RELAY dcm */
	oldValue = CMDQ_REG_GET32(MMSYS_CONFIG_BASE + 0x120);
	CMDQ_REG_SET32(MMSYS_CONFIG_BASE + 0x120, oldValue | 0x1 << 26);
...
static u32 mdp_get_poll_gpr(u16 engine, u32 reg_addr)
{
	...
	case ENGBASE_MDP_CCORR0:
		gpr = CMDQ_GPR_R14;
		break;
	case ENGBASE_MDP_WDMA:
